      ...
      <>
        <div className="movieByIdContainer">
          <div className="movieById">
            ...
            <MoviesInfo
              title={this.state.movies.title}
              vote_average={this.state.movies.vote_average}
            />
          </div>
          <div className="movieByIdInfo">
            <ul>
              ...
              <li>
                <label className="date">IMDb </label>
                <label className="spaceBetweenText">
                  {this.state.movies.vote_average}{" "}
                  {this.state.movies.release_date}
                </label>
              </li>
              <li>
                <div className="overviewText">{this.state.movies.overview}</div>
              </li>
              {/* <li><div>{<Rate value="moviesByIdRate" action="Rate" id={this.props.id}/>}</div></li> */}
              <li>
                <MoviesReviewUsers
                  id={this.props.id}
                  value="moviesByIdRate"
                  action="Rate"
                />
              </li>
            </ul>
